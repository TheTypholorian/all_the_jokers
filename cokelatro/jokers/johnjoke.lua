SMODS.Joker{ --John Joke
    ...
    loc_txt = {
        ...
        ['text'] = {
            ...
            [3] = 'all {C:red,E:1}glitched{} jokers give {C:dark_edition}^2{} Mult',
            [4] = '{C:inactive}(only prevents death once){}'
        },
        ['unlock'] = {
    ...
    loc_vars = function(self, info_queue, card)
        ...
        return {vars = {card.ability.extra.hasdied, card.ability.extra.powermultvar, card.ability.extra.respect, card.ability.extra.var1, card.ability.extra.yes, new_numerator, new_denominator}}
    end,
    ...
    calculate = function(self, card, context)
        ...
        if context.cardarea == G.jokers and context.joker_main  then
            if true then
                if SMODS.pseudorandom_probability(card, 'group_0_3c2387d0', 1, card.ability.extra.odds, 'j_cokelatr_johnjoke', false) then
