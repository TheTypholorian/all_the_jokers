SMODS.Joker{ --Chalk Drawing
    ...
    loc_txt = {
        ...
        ['text'] = {
            ...
            [2] = 'have a {C:green}#1# in #2#{} chance to make',
    ...
    calculate = function(self, card, context)
        if context.individual and context.cardarea == G.hand and not context.end_of_round  then
            if SMODS.get_enhancements(context.other_card)["m_cokelatr_pastel"] == true then
                if SMODS.pseudorandom_probability(card, 'group_0_54652aac', 1, card.ability.extra.odds, 'j_cokelatr_chalkdrawing', false) then
              SMODS.calculate_effect({func = function()local created_consumable = true
                G.E_MANAGER:add_event(Event({
                    func = function()
                        ...
                        SMODS.add_card{set=random_set, edition = 'e_negative', soulable = undefined, key_append='joker_forge_' .. random_set:lower()}
                        return true
                    end
                }))
