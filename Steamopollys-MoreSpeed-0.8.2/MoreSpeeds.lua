...
function G.UIDEF.settings_tab(tab)
    ...
    if tab == 'Game' then
        local speeds = create_option_cycle({label = localize('b_set_gamespeed'),scale = 0.8, options = {0.25, 0.5, 1, 2, 3, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4196}, opt_callback = 'change_gamespeed', current_option = (
