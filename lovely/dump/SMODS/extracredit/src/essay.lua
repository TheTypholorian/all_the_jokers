LOVELY_INTEGRITY = 'c2cf0cea352d120ab5c74a4833accda0455ba34613a5c6738e80035f3100353f'
...
SMODS.Joker{ --Starfruit
    ...
    calculate = function(self, card, context)
        if context.cardarea == G.jokers and G.GAME.current_round.hands_played == 0 and context.before then 
            ...
            if SMODS.food_expires() and not context.blueprint then
...
SMODS.Joker{ --Compost
    ...
    calculate = function(self, card, context)
        ...
        if context.discard and not context.blueprint and card.ability.extra.do_once then
            ...
            if card.ability.extra.mult >= 30 and SMODS.food_expires() then
...
SMODS.Joker{ --Espresso
    ...
    calculate = function(self, card, context)
        ...
        elseif context.end_of_round and not context.individual and not context.repetition and not context.blueprint and SMODS.food_expires() then
...
SMODS.Joker{ --Ambrosia
    ...
    calculate = function(self, card, context)
        ...
        elseif context.selling_card then
            if SMODS.food_expires() and context.card.ability.set == 'Spectral' then
                G.E_MANAGER:add_event(Event({
                    func = function()
                        play_sound('tarot1')
                        card.T.r = -0.2
