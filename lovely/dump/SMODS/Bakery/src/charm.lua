LOVELY_INTEGRITY = 'eb4f537b52da0aad3edd26a20630c89606efd8598c7ca18516b2a6ad1714b1eb'
    ...
    function Bakery_API.add_charms_to_shop()
        ...
        for _, key in ipairs(G.GAME.current_round.Bakery_charm or {}) do
            if G.P_CENTERS[key] and G.GAME.current_round.Bakery_charm.spawn[key] and key ~= 'j_joker' then
                if not G.GAME.modifiers.chdp_disable_charms then Bakery_API.add_charm_to_shop(key, 'shop_voucher') end
            end
        end
    end
