LOVELY_INTEGRITY = '3d790de2f512c6d16aff5695037b9ce452634471d64faa44e0a8a8f79254f4e7'
...
function create_UI_mod_buttons_math()
    scale = 0.4
    local t = G.GAME.modifiers.chdp_hide_skills_grim and nil or {n=G.UIT.R, config={align = "cm", id = 'skill_tree_ui', colour = G.C.CLEAR, paddng = 0.1}, nodes = {
