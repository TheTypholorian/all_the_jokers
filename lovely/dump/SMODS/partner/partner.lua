LOVELY_INTEGRITY = '2563386c56209b3692fa0225729b28a71dd17c9341444162ed88c584a0eb7bdf'
...
function Game:start_run(args)
    ...
    if any_unlocked and not G.GAME.selected_partner and not G.GAME.skip_partner and Partner_API.config.enable_partner then
        G.E_MANAGER:add_event(Event({func = function()
            if not G.GAME.modifiers.chdp_disabled_partner then G.FUNCS.run_setup_partners_option() end
        return true end}))
