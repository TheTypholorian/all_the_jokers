LOVELY_INTEGRITY = '72b6bbfad69eb96d90c77883f396758160b9b22d48fbbd383b41071f4246b19c'
...
function predict_next_ante()
    ...
    local chdp_boss2 = get_new_boss()
    chdp_boss = get_new_boss()
    local boss = get_new_boss()
    G.GAME.bosses_used[boss] = G.GAME.bosses_used[boss] - 1
    G.GAME.bosses_used[chdp_boss2] = G.GAME.bosses_used[chdp_boss2] - 1
...
function create_ante_preview()
    ...
    local blinds = (G.GAME.modifiers.chdp_third_boss and {"Small","Big","ChDp_Boss2", "ChDp_Boss","Boss"}) or (G.GAME.modifiers.second_boss and {"Small","Big","ChDp_Boss","Boss"}) or {"Small","Big","Boss"}
    for _, choice in ipairs(blinds) do
        if prediction[choice] then
            ...
            local tag = not(G.GAME.modifiers.disable_skipping) and prediction[choice].tag or nil
            local tag_sprite
