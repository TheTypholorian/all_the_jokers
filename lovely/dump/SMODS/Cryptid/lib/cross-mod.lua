LOVELY_INTEGRITY = 'b2c27fd30075baa697bbb6ff9d2d96a160d7f384590f628a9c07bf1ab843bf32'
...
if (SMODS.Mods["AntePreview"] or {}).can_load then
	...
	function predict_next_ante()
		...
		if predictions.Small then
		    predictions.Small.blind = small
		end
		if predictions.Big then
		    predictions.Big.blind = big
		end
		if predictions.Small and G.P_BLINDS[predictions.Small.blind].boss then
			G.GAME.bosses_used[predictions.Small.blind] = G.GAME.bosses_used[predictions.Small.blind] - 1
		end
		if predictions.Big and G.P_BLINDS[predictions.Big.blind].boss then
