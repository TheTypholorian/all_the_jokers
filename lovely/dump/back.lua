...
function Back:trigger_effect(args)
    ...
    if ((G.GAME.blind and (G.GAME.blind.name == 'Obscure Overshoot')) or G.GAME.modifiers["always_overshoot"]) and not (G.GAME.blind.disabled) and (args.context == 'final_scoring_step') then
