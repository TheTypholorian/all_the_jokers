...
G.FUNCS.load_profile = function(delete_prof_data)
  ...
  G.E_MANAGER:add_event(Event({
    ...
    func = function()
      ...
      if MINTY then MINTY.lastmoment() end
      return true
    end
  }))
  G.E_MANAGER:add_event(Event({
...
G.FUNCS.buy_from_shop = function(e)
  ...
  G.FUNCS.skip_blind = function(e)
    ...
    if G.GAME.modifiers.chaos_engine_skip then --i can do anything!
    ...
    if _tag and not G.GAME.events.ev_cry_choco2 then 
      ...
      local skipped, skip_to = G.GAME.blind_on_deck or 'Small', 
      G.GAME.blind_on_deck == 'Small' and 'Big' or (G.GAME.blind_on_deck == 'Big' and G.GAME.modifiers.chdp_third_boss) and 'ChDp_Boss2' or (G.GAME.blind_on_deck == 'Big' and G.GAME.modifiers.second_boss) and 'ChDp_Boss' or G.GAME.blind_on_deck == 'Big' and 'Boss' or 'Boss'
      G.GAME.round_resets.blind_states[skipped] = 'Skipped'
      G.GAME.round_resets.blind_states[skip_to] = 'Select'
      G.GAME.blind_on_deck = skip_to
      play_sound('generic1')
