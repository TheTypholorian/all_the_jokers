SMODS.Seal {
   ...
   loc_txt = {
    ...
    loc_vars = function(self, info_queue, card)
        local numerator, denominator = SMODS.get_probability_vars(card, 1, card.ability.seal.extra.odds, 'shit_cakeseal')
    ...
    calculate = function(self, card, context)
        ...
        if context.main_scoring and context.cardarea == G.play then
            ...
            if SMODS.pseudorandom_probability(card, 'group_0_952a5394', 1, card.ability.seal.extra.odds, 'm_shit_cakeseal', false) then
